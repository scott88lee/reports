...
# echo "Uploading API-gateway swagger definitions"
# cd ..
# echo "file://$(pwd)/ReportService-dev-swagger.yaml"

# aws apigateway import-rest-api --body "file://$(pwd)/api-gateway/ReportService-dev-swagger.yaml"
